...
Code from final solution using a kind
of "synthetic" linked list (i.e., not actually building one)
to find a duplicate.

I want to step through this code in detail to ensure I understand
the pattern.`
"""
